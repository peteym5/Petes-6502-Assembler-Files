...
INFLATE
  STA Outputpointer
  STY Outputpointer+1
  LDA COMPRESS_ADDRESS_LOW,X
  STA inputPointer+0
  LDA COMPRESS_ADDRESS_HIGH,X
  STA inputPointer+1
;  LDY #3
;Set_Inflate_Addr_Loop
; LDA inflateDynamicBlock_init,Y 
; STA inflateDynamicBlock_headerBase,Y
; DEY 
; BPL Set_Inflate_Addr_Loop 
...
COMPRESS_ADDRESS_LOW  
  DTA <COMPFONT1,<COMPFONT2,<COMPBLOCK1,<COMPBLOCK2,<COMPBLOCK3,<COMPBLOCK4
COMPRESS_ADDRESS_HIGH
  DTA >COMPFONT1,>COMPFONT2,>COMPBLOCK1,>COMPBLOCK2,>COMPBLOCK3,>COMPBLOCK4
